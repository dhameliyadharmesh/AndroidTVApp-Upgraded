...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        binding.switchEnable.setChecked(
                mSettingsManager.getBoolean(Constants.BOOT_APP_ENABLED));
        ...
        binding.switchEnable.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mSettingsManager.setBoolean(
                        Constants.BOOT_APP_ENABLED, isChecked);
                changeSelectedView();
            }
        });
        ...
        binding.buttonSelectApp.setOnClickListener(v -> new AlertDialog.Builder(new ContextThemeWrapper(HomeActivity.this, android.R.style.Theme_Material_Light_Dialog))
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(new AppReceiver(), new IntentFilter(Intent.ACTION_SCREEN_ON));
    ...
    private void changeSelectedView() {
